...
[![](./Images/Mixed_Radix_IFFT_Stream_Ex1.png)](https://github.com/Xilinx/Vitis_Model_Composer/tree/2025.2/Examples/Block_Help/AIE/Mixed_Radix_IFFT_Stream_Ex1)


<!--
DESCRIPTION:
Model: Mixed_Radix_IFFT_Stream_Ex1
Generated: 13-Jan-2026 15:37:29

Vitis Model Composer Configuration:
  Target Device: xcvc1902-vsva2197-1LP-e-S

Vitis Model Composer Blocks:
  - AIE: Mixed-Radix IFFT Stream
  - AIE: To Fixed Size
...
Model Annotations:
  ...
  Input: Comlex Signal with 5 KHz frequency

  p, li { white-space: pre-wrap; }
  Observation on IFFT Output:
  Complex Signal in time-domain
  Outut Frame Size = 1024
  AIE & Simulink Radix IFFT output signals are perfectly matching

Description:
This MATLAB script creates a Vitis Model Composer Simulink model that uses the AI Engine Mixed-Radix IFFT Stream block. A 5kHz complex input signal is provided to the block,  and the block's output is compared to a Simulink golden reference.
...
% Quick Start: Mixed_Radix_IFFT_Stream_Ex1
% Essential setup focusing on critical parameters

modelName = 'Mixed_Radix_IFFT_Stream_Ex1';
...
% Mixed-Radix IFFT Stream
add_block('aieDSP/Mixed-Radix IFFT Stream', [modelName '/Mixed-Radix IFFT Stream']);
set_param([modelName '/Mixed-Radix IFFT Stream'], ...
    'data_type', 'cint16', ...
    'twiddle_type', 'cint16', ...
    'point_size', '1024', ...
...
% Mixed-Radix IFFT Stream
add_block('aieDSP/Mixed-Radix IFFT Stream', [modelName '/Mixed-Radix IFFT Stream1']);
set_param([modelName '/Mixed-Radix IFFT Stream1'], ...
    'data_type', 'cint16', ...
    'twiddle_type', 'cint16', ...
    'point_size', '1024', ...
    'input_window_size', '1024', ...
