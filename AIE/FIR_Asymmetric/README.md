...
Generated: 13-Jan-2026 15:37:04
...
Model Annotations:
  ...
  p, li { white-space: pre-wrap; }
  function coeffs = FIR_Asymmetric_Coeff()
  ...
  Input: Complex Signal with 2KHz frequency

  p, li { white-space: pre-wrap; }
  Observation on filter output:
  Output sampling rate: 100 KHz
  Output frame size: 1024
  Complex signal with 2 KHz frequency
  AIE and Simulink FIR filter outputs are perfectly matching.
...
% Quick Start: FIR_Asymmetric_Ex1
% Essential setup focusing on critical parameters

modelName = 'FIR_Asymmetric_Ex1';
...
Generated: 13-Jan-2026 15:37:05
...
Model Annotations:
  ...
  Output sampling rate: 100 KHz
  Output frame size: 1024
  Filter output is scaled down by 2^15.
  AIE and Simulink FIR filter outputs are perfectly matching.
...
% Quick Start: FIR_Asymmetric_Ex2
% Essential setup focusing on critical parameters

modelName = 'FIR_Asymmetric_Ex2';
new_system(modelName); open_system(modelName);
