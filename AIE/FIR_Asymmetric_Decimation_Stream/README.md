...
Generated: 09-Jan-2026 13:43:14
...
% create_FIR_AsymmetricDecimator_Stream_Ex1_model.m
% Auto-generated script to recreate the FIR_AsymmetricDecimator_Stream_Ex1 Simulink model
% Generated on: 09-Jan-2026 13:43:14

%% Model Configuration
modelName = 'FIR_AsymmetricDecimator_Stream_Ex1_recreated';
...
set_param([modelName '/FIR Asymmetric Decimation Stream'], ...
    ...
    'casc_length', '4', ...
    'TP_API', '1');
add_block('built-in/Constant', [modelName '/FIR_AsymmetricDecimatorStream_Coeff()'], ...
    'Position', [350 270 380 300]);
set_param([modelName '/FIR_AsymmetricDecimatorStream_Coeff()'], ...
    'Value', 'coeffs', ...
    'VectorParams1D', 'on', ...
    'OutMin', '[]', ...
    'OutMax', '[]', ...
...
add_line(modelName, 'FIR Asymmetric Decimation Stream/2', 'AIE & Simulink_Spectrum_Comparison/2', 'autorouting', 'on');
add_line(modelName, 'FIR_AsymmetricDecimatorStream_Coeff()/2', 'Simulink_FIR DecimationFactor = 2 & FrameSize = 1024/3', 'autorouting', 'on');
add_line(modelName, 'FIR_AsymmetricDecimatorStream_Coeff()/2', 'FIR Asymmetric Decimation Stream/3', 'autorouting', 'on');
add_line(modelName, 'FIR_AsymmetricDecimatorStream_Coeff()/2', 'FIR Asymmetric Decimation Stream/3', 'autorouting', 'on');
add_line(modelName, 'Complex_Signal_2KHz/2', 'Simulink_FIR DecimationFactor = 2 & FrameSize = 1024/2', 'autorouting', 'on');
add_line(modelName, 'Complex_Signal_2KHz/2', 'FIR Asymmetric Decimation Stream/2', 'autorouting', 'on');
add_line(modelName, 'Complex_Signal_2KHz/2', 'FIR Asymmetric Decimation Stream/2', 'autorouting', 'on');
