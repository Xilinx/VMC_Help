...
[![](./Images/FIR_AsymmetricDecimator_Stream_Ex1.png)](https://github.com/Xilinx/Vitis_Model_Composer/tree/2025.2/Examples/Block_Help/AIE/FIR_AsymmetricDecimator_Stream_Ex1)


<!--
DESCRIPTION:
Model: FIR_AsymmetricDecimator_Stream_Ex1
Generated: 13-Jan-2026 15:37:02

Vitis Model Composer Configuration:
  Target Device: xcvc1902-vsva2197-1LP-e-S

Vitis Model Composer Blocks:
  - AIE: FIR Asymmetric Decimation Stream

Model Annotations:
  p, li { white-space: pre-wrap; }
  Observation on Filter ouput:
  Output Frame Size = 512
  Output Sampling Rate = 25 ksps (Input Sampling Rate / Decimation Factor)
  ...
  p, li { white-space: pre-wrap; }
  function coeffs = FIR_AsymmetricDecimatorStream_Coeff()
...
Description:
This MATLAB script creates a Vitis Model Composer Simulink model that uses the AI Engine FIR Asymmetric Decimation Stream block. A 2kHz complex input signal is provided to the block,  and results are compared against a Simulink reference implementation.
...
% Quick Start: FIR_AsymmetricDecimator_Stream_Ex1
% Essential setup focusing on critical parameters

modelName = 'FIR_AsymmetricDecimator_Stream_Ex1';
...
% FIR Asymmetric Decimation Stream
add_block('aieDSP/FIR Asymmetric Decimation Stream', [modelName '/FIR Asymmetric Decimation Stream']);
set_param([modelName '/FIR Asymmetric Decimation Stream'], ...
    'data_type', 'cfloat', ...
    'coef_type', 'float', ...
    'use_coeff_reload', 'on', ...
    'coeff', '[1, zeros(1,25)]', ...
