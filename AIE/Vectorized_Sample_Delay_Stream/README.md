...
Generated: 09-Jan-2026 13:50:14
...
% create_Vectorized_SampleDelay_Stream_Ex1_model.m
% Auto-generated script to recreate the Vectorized_SampleDelay_Stream_Ex1 Simulink model
% Generated on: 09-Jan-2026 13:50:14

%% Model Configuration
modelName = 'Vectorized_SampleDelay_Stream_Ex1_recreated';
...
add_line(modelName, 'Vectorized Sample Delay Stream/2', 'AIE_Simulink_SampleDelay_Comparison/2', 'autorouting', 'on');
add_line(modelName, 'SampleDelay/2', 'Variable Integer Delay/3', 'autorouting', 'on');
add_line(modelName, 'SampleDelay/2', 'Vectorized Sample Delay Stream/3', 'autorouting', 'on');
add_line(modelName, 'SampleDelay/2', 'Vectorized Sample Delay Stream/3', 'autorouting', 'on');
add_line(modelName, 'Variable Integer Delay/2', 'AIE_Simulink_SampleDelay_Comparison/3', 'autorouting', 'on');
add_line(modelName, 'Sine Wave/2', 'Vectorized Sample Delay Stream/2', 'autorouting', 'on');
