...
[![](./Images/FIR_HBInterpolator_Stream_Ex1.png)](https://github.com/Xilinx/Vitis_Model_Composer/tree/2025.2/Examples/Block_Help/AIE/FIR_HalfbandInterpolatorStream_Ex1)


<!--
DESCRIPTION:
Model: FIR_HalfbandInterpolatorStream_Ex1
Generated: 13-Jan-2026 15:37:06

Vitis Model Composer Configuration:
  Target Device: xcvc1902-vsva2197-1LP-e-S

Vitis Model Composer Blocks:
  - AIE: FIR Halfband Interpolator Stream
...
Model Annotations:
  ...
  HalfBandInterpolator  = 2*firhalfband('minorder', 10e3/(100e3/2), 5.7564627261e-05);
  FilterCoefficients = HalfBandInterpolator([ 1:2:(length(HalfBandInterpolator)-1)/2 (length(HalfBandInterpolator)+1)/2]);

Description:
This MATLAB script creates a Vitis Model Composer Simulink model that uses the AI Engine FIR Halfband Interpolator Stream block. A 4kHz complex input signal is provided to the block, 
...
% Quick Start: FIR_HalfbandInterpolatorStream_Ex1
% Essential setup focusing on critical parameters

modelName = 'FIR_HalfbandInterpolatorStream_Ex1';
...
% FIR Halfband Interpolator Stream
add_block('aieDSP/FIR Halfband Interpolator Stream', [modelName '/FIR Halfband Interpolator Stream']);
set_param([modelName '/FIR Halfband Interpolator Stream'], ...
    'data_type', 'cfloat', ...
    'coef_type', 'float', ...
