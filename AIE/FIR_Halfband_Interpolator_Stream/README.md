...
Generated: 09-Jan-2026 13:43:53
...
% create_FIR_HalfbandInterpolatorStream_Ex1_model.m
% Auto-generated script to recreate the FIR_HalfbandInterpolatorStream_Ex1 Simulink model
% Generated on: 09-Jan-2026 13:43:53

%% Model Configuration
modelName = 'FIR_HalfbandInterpolatorStream_Ex1_recreated';
...
add_block('dspsrcs4/Sine Wave', [[modelName '/Complex_Signal_4KHz '] '/Complex_Sig_4KHz'], ...
    'Position', [15 33 60 77]);
set_param([[modelName '/Complex_Signal_4KHz '] '/Complex_Sig_4KHz'], ...
    'Amplitude', '0.2', ...
    'Frequency', '4e3', ...
    'Phase', '0', ...
    'SampleMode', 'Discrete', ...
...
add_line([modelName '/Complex_Signal_4KHz '], 'Complex_Sig_4KHz/2', 'Out1/2', 'autorouting', 'on');

%% Create Simulink_Halfband_Interpolator Subsystem
add_block('built-in/SubSystem', [modelName '/Simulink_Halfband_Interpolator'], ...
    'Position', [430 247 545 323]);

% Remove default blocks
defaultBlocks = find_system([modelName '/Simulink_Halfband_Interpolator'], 'SearchDepth', 1, 'Type', 'block');
for i = 1:length(defaultBlocks)
    if ~strcmp(defaultBlocks{i}, [modelName '/Simulink_Halfband_Interpolator'])
        delete_block(defaultBlocks{i});
    end
end

add_block('built-in/Inport', [[modelName '/Simulink_Halfband_Interpolator'] '/In1'], ...
    'Position', [20 23 50 37]);
set_param([[modelName '/Simulink_Halfband_Interpolator'] '/In1'], ...
    'Port', '1', ...
    'IconDisplay', 'Port number', ...
    'OutputFunctionCall', 'off', ...
    'OutMin', '[]', ...
...
add_block('dspmlti4/FIR Halfband Interpolator', [[modelName '/Simulink_Halfband_Interpolator'] '/FIR Halfband Interpolator1'], ...
    'Position', [165 8 270 52]);
set_param([[modelName '/Simulink_Halfband_Interpolator'] '/FIR Halfband Interpolator1'], ...
    ...
    'LockScale', 'off');
add_block('built-in/Outport', [[modelName '/Simulink_Halfband_Interpolator'] '/Out1'], ...
    'Position', [385 23 415 37]);
set_param([[modelName '/Simulink_Halfband_Interpolator'] '/Out1'], ...
    'Port', '1', ...
    'StorageClass', 'Auto', ...
    'IconDisplay', 'Port number', ...
    'OutputFunctionCall', 'off', ...
...
% Connect blocks in Simulink_Halfband_Interpolator
add_line([modelName '/Simulink_Halfband_Interpolator'], 'FIR Halfband Interpolator1/2', 'Out1/2', 'autorouting', 'on');
add_line([modelName '/Simulink_Halfband_Interpolator'], 'In1/2', 'FIR Halfband Interpolator1/2', 'autorouting', 'on');

%% Connect Top-Level Blocks
add_line(modelName, 'Simulink_Halfband_Interpolator/2', 'AIE_Simulink_SpectrumComparison/3', 'autorouting', 'on');
add_line(modelName, 'FIR Halfband Interpolator Stream/2', 'AIE_Simulink_SpectrumComparison/2', 'autorouting', 'on');
add_line(modelName, 'Complex_Signal_4KHz /2', 'Simulink_Halfband_Interpolator/2', 'autorouting', 'on');
add_line(modelName, 'Complex_Signal_4KHz /2', 'FIR Halfband Interpolator Stream/2', 'autorouting', 'on');
add_line(modelName, 'Complex_Signal_4KHz /2', 'FIR Halfband Interpolator Stream/2', 'autorouting', 'on');
