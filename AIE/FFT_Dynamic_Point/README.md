...
Generated: 13-Jan-2026 15:36:58
...
Model Annotations:
  ...
  FFT maximum size: 1024
  Input Window SIze: 1024
  Input: Complex Signal with 6KHz frequency
  with 20KHz sampling frequency

  p, li { white-space: pre-wrap; }
  Observation on AIE & Simulink Dynamic FFT Output:
  Output Frame Size  = 1024
  FFT Bin Number = 307
  FFT Bin Number * (sampling frequency / FFT size)  =  Input Signal Frequency
  307*(20e3/1024) = 6 KHz
...
% Quick Start: DynamicFFT_Ex1
% Essential setup focusing on critical parameters

modelName = 'DynamicFFT_Ex1';
...
Generated: 13-Jan-2026 15:36:59
...
Model Annotations:
  ...
  p, li { white-space: pre-wrap; }
  Model Parameter Settings:
  FFT maximum size: 512
  Input Window SIze: 512
  Input: Complex Signal with 4KHz frequency
  with 20KHz sampling frequency
...
% Quick Start: DynamicFFT_Ex2
% Essential setup focusing on critical parameters

modelName = 'DynamicFFT_Ex2';
new_system(modelName); open_system(modelName);
