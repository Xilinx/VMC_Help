...
Generated: 13-Jan-2026 15:36:44
...
% Quick Start: Bitonic_Sort_Ex1
% Essential setup focusing on critical parameters

modelName = 'Bitonic_Sort_Ex1';
...
% Bitonic Sort
add_block('aieDSP/Bitonic Sort', [modelName '/Bitonic Sort']);
set_param([modelName '/Bitonic Sort'], ...
    'data_type', 'int16', ...
    'ssr', '1');
...
Generated: 13-Jan-2026 15:36:45
...
% Quick Start: Bitonic_Sort_Ex2
% Essential setup focusing on critical parameters

modelName = 'Bitonic_Sort_Ex2';
new_system(modelName); open_system(modelName);
