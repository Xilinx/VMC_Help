...
[![](./Images/IDFT_Block_Ex1.png)](https://github.com/Xilinx/Vitis_Model_Composer/tree/2025.2/Examples/Block_Help/AIE/IDFT_Ex1)


<!--
DESCRIPTION:
Model: IDFT_Ex1
Generated: 13-Jan-2026 15:37:22
...
Model Annotations:
  ...
  Observation On IDFT Output:
  Complex time-domain signal
  Output Sample Size: 128
  AIE IDFT and Simulink IDFT Output signals are matching

  p, li { white-space: pre-wrap; }
  Model Parameter Settings:
  IDFT Size = 128
  No.of frames per window = 1
  Input: Comlex Signal with 25KHz frequency

Description:
This MATLAB script creates a Vitis Model Composer Simulink model that uses the AI Engine IDFT block. A 25kHz complex input signal is provided to the block,  and the output is visualized for analysis.
...
% IDFT
add_block('aieDSP/IDFT', [modelName '/IDFT']);
set_param([modelName '/IDFT'], ...
    'data_type', 'cfloat', ...
    'twiddle_type', 'cfloat', ...
    'point_size', '128', ...
    'shift_val', '0', ...
...
[![](./Images/IDFT_Block_Ex2.png)](https://github.com/Xilinx/Vitis_Model_Composer/tree/2025.2/Examples/Block_Help/AIE/IDFT_Ex2)
...
Model Annotations:
  ...
  Observation On IDFT Output:
  Complex time-domain signal
  Output Sample Size: 512
  AIE IDFT and Simulink IDFT Output signals are matching

  p, li { white-space: pre-wrap; }
  Model Parameter Settings:
  IDFT Size = 128
  No.of frames per window = 4
  Input: Comlex Signal with 25 KHz frequency
...
% IDFT
add_block('aieDSP/IDFT', [modelName '/IDFT1']);
set_param([modelName '/IDFT1'], ...
    'data_type', 'cfloat', ...
    'twiddle_type', 'cfloat', ...
    'point_size', '128', ...
    'shift_val', '0', ...
