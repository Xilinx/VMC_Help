...
DESCRIPTION:
Model: IDFT_Ex1
Generated: 09-Jan-2026 13:45:52
...
% create_IDFT_Ex1_model.m
% Auto-generated script to recreate the IDFT_Ex1 Simulink model
% Generated on: 09-Jan-2026 13:45:52

%% Model Configuration
modelName = 'IDFT_Ex1_recreated';
...
add_block('built-in/ArrayPlot', [modelName '/AIE_Simulink_IDFT_Output_ImaginaryPart_Comparison '], ...
    'Position', [1100 222 1145 273]);
set_param([modelName '/AIE_Simulink_IDFT_Output_ImaginaryPart_Comparison '], ...
    'NumInputPorts', '2', ...
    ...
    'ShowLegend', 'on', ...
    'ChannelNames', '[]');
add_block('built-in/ArrayPlot', [modelName '/AIE_Simulink_IDFT_Output_RealPart_Comparison'], ...
    'Position', [1250 172 1295 223]);
set_param([modelName '/AIE_Simulink_IDFT_Output_RealPart_Comparison'], ...
    'NumInputPorts', '2', ...
    'OpenAtSimulationStart', 'on', ...
    ...
    'PlotAsMagnitudePhase', 'off', ...
    'YLabel', 'Amplitude', ...
    'YLimits', '[-159.9998,159.9998]', ...
    'ShowGrid', 'on', ...
    'ShowLegend', 'on', ...
    'ChannelNames', '[]');
add_block('aieDSP/IDFT', [modelName '/IDFT'], ...
    'Position', [440 140 545 200]);
...
add_block('built-in/Inport', [[modelName '/AIE_Simulink_TimeDomain_SignalComparison'] '/AIE_IDFT'], ...
    'Position', [80 168 110 182]);
set_param([[modelName '/AIE_Simulink_TimeDomain_SignalComparison'] '/AIE_IDFT'], ...
    'Port', '1', ...
...
add_block('built-in/Inport', [[modelName '/AIE_Simulink_TimeDomain_SignalComparison'] '/Simulink_IDFT'], ...
    'Position', [80 243 110 257]);
set_param([[modelName '/AIE_Simulink_TimeDomain_SignalComparison'] '/Simulink_IDFT'], ...
    'Port', '2', ...
    'IconDisplay', 'Port number', ...
    'OutputFunctionCall', 'off', ...
    'OutMin', '[]', ...
...
add_line([modelName '/AIE_Simulink_TimeDomain_SignalComparison'], 'Simulink_IDFT/2', 'Complex to Real-Imag1/2', 'autorouting', 'on');
...
add_line([modelName '/AIE_Simulink_TimeDomain_SignalComparison'], 'AIE_IDFT/2', 'Complex to Real-Imag/2', 'autorouting', 'on');

%% Create DFT_Complex_Signal_25KHz Subsystem
add_block('built-in/SubSystem', [modelName '/DFT_Complex_Signal_25KHz'], ...
    'Position', [155 176 240 244]);
...
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/4', 'AIE_Simulink_IDFT_Output_ImaginaryPart_Comparison /2', 'autorouting', 'on');
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/3', 'AIE_Simulink_IDFT_Output_RealPart_Comparison/3', 'autorouting', 'on');
add_line(modelName, 'DFT_Complex_Signal_25KHz/2', 'MATLAB IDFT Function/2', 'autorouting', 'on');
add_line(modelName, 'DFT_Complex_Signal_25KHz/2', 'IDFT/2', 'autorouting', 'on');
add_line(modelName, 'DFT_Complex_Signal_25KHz/2', 'IDFT/2', 'autorouting', 'on');
add_line(modelName, 'IDFT/2', 'AIE_Simulink_TimeDomain_SignalComparison/2', 'autorouting', 'on');
add_line(modelName, 'MATLAB IDFT Function/2', 'AIE_Simulink_TimeDomain_SignalComparison/3', 'autorouting', 'on');
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/2', 'AIE_Simulink_IDFT_Output_RealPart_Comparison/2', 'autorouting', 'on');
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/5', 'AIE_Simulink_IDFT_Output_ImaginaryPart_Comparison /3', 'autorouting', 'on');
...
DESCRIPTION:
Model: IDFT_Ex2
Generated: 09-Jan-2026 13:45:55
...
% create_IDFT_Ex2_model.m
% Auto-generated script to recreate the IDFT_Ex2 Simulink model
% Generated on: 09-Jan-2026 13:45:55

%% Model Configuration
modelName = 'IDFT_Ex2_recreated';
...
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/4', 'AIE_Simulink_IDFT_Output_ImaginaryPart_Comparison /2', 'autorouting', 'on');
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/3', 'AIE_Simulink_IDFT_Output_RealPart_Comparison/3', 'autorouting', 'on');
add_line(modelName, 'DFT_Complex_Signal_25KHz/2', 'IDFT1/2', 'autorouting', 'on');
add_line(modelName, 'DFT_Complex_Signal_25KHz/2', 'MATLAB IDFT Function/2', 'autorouting', 'on');
add_line(modelName, 'DFT_Complex_Signal_25KHz/2', 'MATLAB IDFT Function/2', 'autorouting', 'on');
add_line(modelName, 'IDFT1/2', 'AIE_Simulink_TimeDomain_SignalComparison/2', 'autorouting', 'on');
add_line(modelName, 'MATLAB IDFT Function/2', 'AIE_Simulink_TimeDomain_SignalComparison/3', 'autorouting', 'on');
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/2', 'AIE_Simulink_IDFT_Output_RealPart_Comparison/2', 'autorouting', 'on');
add_line(modelName, 'AIE_Simulink_TimeDomain_SignalComparison/5', 'AIE_Simulink_IDFT_Output_ImaginaryPart_Comparison /3', 'autorouting', 'on');
