...
Generated: 13-Jan-2026 15:37:10
...
Model Annotations:
  ...
  Input sample size = 1536
  Input Signal: complex signal with 15 KHz frequency

  p, li { white-space: pre-wrap; }
  Observation on output:
  Output sampling rate = 66.67 KHz (Input Sampling Rate *
  $(InterpolationFactor / DecimationFactor)$
  )
  Output sample size = 1024
  Output Signal: complex signal with 15 KHz frequency
...
% Quick Start: FIR_Resampler_Ex1
% Essential setup focusing on critical parameters

modelName = 'FIR_Resampler_Ex1';
