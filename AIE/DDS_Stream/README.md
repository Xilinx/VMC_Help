...
Generated: 13-Jan-2026 15:36:54
...
Model Annotations:
  ...
  Phase Increment (Fo*(2^N)) / Fs:
  2^32*(100e3/4e6)
  Sampling Frequency Fs: 4MHz
  Output Frequency: 100 KHz
...
% Quick Start: DDS_Stream_Ex1
% Essential setup focusing on critical parameters

modelName = 'DDS_Stream_Ex1';
...
% Quick Start: DDS_Stream_Ex2
% Essential setup focusing on critical parameters

modelName = 'DDS_Stream_Ex2';
new_system(modelName); open_system(modelName);
