...
Generated: 13-Jan-2026 15:37:35
...
Model Annotations:
  ...
  Output sampling rate = 60 KHz (Input Sampling Rate *
  $(InterpolationFactor / DecimationFactor)$
  )
  Output sample size = 3072
  (Input sample size *
  $(InterpolationFactor / DecimationFactor)$
  )
  Output Signal: complex signal with 10 KHz frequency

  p, li { white-space: pre-wrap; }
  Model Configuration Parameters:
  Interpolation Factor = 3
  Decimation Factor = 2
  Input sampling rate = 40 KHz
  Input sample size = 2048
  Input Signal: complex signal with 10 KHz frequency
...
% Quick Start: Resampler_Stream_Ex1
% Essential setup focusing on critical parameters

modelName = 'Resampler_Stream_Ex1';
...
Generated: 13-Jan-2026 15:37:36
...
Model Annotations:
  p, li { white-space: pre-wrap; }
  Observation on output:
  Output sampling rate = 750 KHz (Input Sampling Rate *
  $(InterpolationFactor / DecimationFactor)$
  )
  Output sample size = 768
  (I
  nput sample size
  *
  $(InterpolationFactor / DecimationFactor)$
  )
  Output Signal: complex signal with 100 KHz frequency

  p, li { white-space: pre-wrap; }
  Model Configuration Parameters:
  Interpolation Factor = 4
  Decimation Factor = 3
  Input sampling rate = 1 MHz
  Input sample size = 1024
  Input Signal: complex signal with 100 KHz frequency
...
% Quick Start: Resampler_Stream_Ex2
% Essential setup focusing on critical parameters

modelName = 'Resampler_Stream_Ex2';
new_system(modelName); open_system(modelName);
