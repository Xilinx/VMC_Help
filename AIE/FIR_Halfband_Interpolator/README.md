...
Generated: 13-Jan-2026 15:37:21
...
Model Annotations:
  ...
  Output: Complex Signal Spectrum with 1 KHz frequency
  ...
  HalfBandInterpolator  = 4*firhalfband('minorder', 10e3/(100e3/2), 5.7564627261e-05);
  FilterCoefficients = HalfBandInterpolator([ 1:2:(length(HalfBandInterpolator)-1)/2 (length(HalfBandInterpolator)+1)/2]);

  p, li { white-space: pre-wrap; }
  Model parameter settings:
  Input Frame Size = 128
  Input Sampling Rate = 50 ksps
  Input: Complex Signal with 1KHz frequency
...
% Quick Start: HalfBandInterpolator_Ex1
% Essential setup focusing on critical parameters

modelName = 'HalfBandInterpolator_Ex1';
...
% Quick Start: HalfBandInterpolator_Ex2
% Essential setup focusing on critical parameters

modelName = 'HalfBandInterpolator_Ex2';
new_system(modelName); open_system(modelName);
