...
[![](./Images/DDS_Block_Ex1.png)](https://github.com/Xilinx/Vitis_Model_Composer/tree/2025.2/Examples/Block_Help/AIE/DDS_Ex1)


<!--
DESCRIPTION:
Model: DDS_Ex1
Generated: 13-Jan-2026 15:36:51
...
Description:
This MATLAB script creates a Vitis Model Composer Simulink model that uses the AI Engine DDS block. 
...
% DDS
add_block('aieDSP/DDS', [modelName '/DDS']);
set_param([modelName '/DDS'], ...
    'data_type', 'cfloat', ...
    'ssr', '1');
...
[![](./Images/DDS_Ex2.png)](https://github.com/Xilinx/Vitis_Model_Composer/tree/2025.2/Examples/Block_Help/AIE/DDS_Ex2)
