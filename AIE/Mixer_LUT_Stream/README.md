...
Generated: 09-Jan-2026 13:49:07
...
% create_Mixer_LUT_Stream_Ex1_model.m
% Auto-generated script to recreate the Mixer_LUT_Stream_Ex1 Simulink model
% Generated on: 09-Jan-2026 13:49:07

%% Model Configuration
modelName = 'Mixer_LUT_Stream_Ex1_recreated';
...
add_line(modelName, 'Complex Signal_900KHz/2', 'Mixer LUT Stream/3', 'autorouting', 'on');
...
add_line(modelName, 'Complex Signal_200KHz/2', 'Mixer LUT Stream/2', 'autorouting', 'on');
add_line(modelName, 'Complex Signal_200KHz/2', 'Mixer LUT Stream/2', 'autorouting', 'on');
add_line(modelName, 'Mixer LUT Stream/2', 'AIE_Simulink_Spectrum_Comparison/2', 'autorouting', 'on');
