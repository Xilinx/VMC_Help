...
Description:
This MATLAB script creates a Vitis Model Composer Simulink model that uses the AI Engine Mixer LUT Stream block. A 900kHz complex input signal is provided to the block, 
...
% Quick Start: Mixer_LUT_Stream_Ex1
% Essential setup focusing on critical parameters

modelName = 'Mixer_LUT_Stream_Ex1';
...
% Mixer LUT Stream
add_block('aieDSP/Mixer LUT Stream', [modelName '/Mixer LUT Stream']);
set_param([modelName '/Mixer LUT Stream'], ...
    'data_type', 'cfloat', ...
    'ssr', '1', ...
