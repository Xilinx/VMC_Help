...
Model Annotations:
  ...
  Observation On IDFT Stream Output:
  Complex time-domain signal
  Output Sample Size: 64
  AIE IDFT Stream and Simulink IDFT Output signals are matching
...
% Quick Start: IDFT_Stream_Ex1
% Essential setup focusing on critical parameters

modelName = 'IDFT_Stream_Ex1';
...
Generated: 13-Jan-2026 15:37:23
...
% Quick Start: IDFT_Stream_Ex2
% Essential setup focusing on critical parameters

modelName = 'IDFT_Stream_Ex2';
new_system(modelName); open_system(modelName);
