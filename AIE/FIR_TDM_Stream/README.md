...
Generated: 09-Jan-2026 13:45:11
...
% create_FIR_TDM_Stream_Ex1_model.m
% Auto-generated script to recreate the FIR_TDM_Stream_Ex1 Simulink model
% Generated on: 09-Jan-2026 13:45:11

%% Model Configuration
modelName = 'FIR_TDM_Stream_Ex1_recreated';
...
add_line(modelName, 'FIR TDM Stream/5', 'Merging/5', 'autorouting', 'on');
add_line(modelName, 'FIR TDM Stream/4', 'Merging/4', 'autorouting', 'on');
add_line(modelName, 'round_robin/5', 'FIR TDM Stream/5', 'autorouting', 'on');
add_line(modelName, 'round_robin/4', 'FIR TDM Stream/4', 'autorouting', 'on');
add_line(modelName, 'FIR TDM Stream/3', 'Merging/3', 'autorouting', 'on');
add_line(modelName, 'FIR TDM Stream/2', 'Merging/2', 'autorouting', 'on');
add_line(modelName, 'Merging/2', 'To Fixed Size/2', 'autorouting', 'on');
add_line(modelName, 'round_robin/3', 'FIR TDM Stream/3', 'autorouting', 'on');
add_line(modelName, 'round_robin/2', 'FIR TDM Stream/2', 'autorouting', 'on');
