...
Description:
This MATLAB script creates a Vitis Model Composer Simulink model that uses the AI Engine FIR TDM Stream block.  and the output is visualized for analysis.
...
% Quick Start: FIR_TDM_Stream_Ex1
% Essential setup focusing on critical parameters

modelName = 'FIR_TDM_Stream_Ex1';
...
% FIR TDM Stream
add_block('aieDSP/FIR TDM Stream', [modelName '/FIR TDM Stream']);
set_param([modelName '/FIR TDM Stream'], ...
    'data_type', 'cfloat', ...
