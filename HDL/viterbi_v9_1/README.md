...
Table 1. Convolution Codes

## Block Interface

The Xilinx Viterbi Decoder 9.1 block is AXI4 compliant. The following
...
([PG027](https://www.xilinx.com/cgi-bin/docs/ipdoc?c=viterbi;v=latest;d=pg027_viterbi_decoder.pdf))
