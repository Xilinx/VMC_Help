...
The Xilinx Reed-Solomon Decoder 8.0 block is AXI4 compliant. The
...
([PG025](https://www.xilinx.com/cgi-bin/docs/ipdoc?c=rs_encoder;v=latest;d=pg025_rs_encoder.pdf))
