...
The Xilinx DDS (Direct Digital Synthesizer) Compiler block implements
...
Figure: DDS Compiler Block Diagram
...
([PG141](https://www.xilinx.com/cgi-bin/docs/ipdoc?c=dds_compiler;v=latest;d=pg141-dds-compiler.pdf))
