...
In the example above, the stream output of this block will be a [variable-size signal](../../GEN/Variable_Size_Signals/README.md) with a maximum size of 4 samples as shown below:
